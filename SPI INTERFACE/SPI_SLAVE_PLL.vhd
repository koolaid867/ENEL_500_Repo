...
-- Module  Version: 5.7
--C:\lscc\diamond\3.8_x64\ispfpga\bin\nt64\scuba.exe -w -n SPI_SLAVE_PLL -lang vhdl -synth lse -arch xo2c00 -type pll -fin 100 -fclkop 100 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 5 -wb 

-- Wed Feb 22 21:21:39 2017
...
architecture Structure of SPI_SLAVE_PLL is
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        port map (CLKI=>CLKI, CLKFB=>CLKFB_t, PHASESEL1=>scuba_vlo, 
            ...
            REFCLK=>open, CLKINTFB=>CLKFB_t, DPHSRC=>open, 
            PLLACK=>PLLACK, PLLDATO7=>PLLDATO(7), PLLDATO6=>PLLDATO(6), 
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of SPI_SLAVE_PLL is
    for Structure
