...
-- Module  Version: 5.7
--C:\lscc\diamond\3.8_x64\ispfpga\bin\nt64\scuba.exe -w -n CLK_FILL_ARRAY -lang vhdl -synth lse -arch xo2c00 -type pll -fin 10 -fclkop 10 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -wb 

-- Fri Feb 24 19:47:19 2017
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  51, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  52, CLKFB_DIV=>  1, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
