...
-- Module  Version: 5.7
--C:\lscc\diamond\3.8_x64\ispfpga\bin\nt64\scuba.exe -w -n CLK_FILL_ARRAY -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 12 -fclkop 12 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -wb 
...
architecture Structure of CLK_FILL_ARRAY is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "12.000000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  42, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  43, CLKFB_DIV=>  1, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
        port map (CLKI=>CLKI, CLKFB=>CLKOP_t, PHASESEL1=>scuba_vlo, 
            ...
            PLLDATI0=>PLLDATI(0), CLKOP=>CLKOP_t, CLKOS=>open, 
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of CLK_FILL_ARRAY is
    for Structure
