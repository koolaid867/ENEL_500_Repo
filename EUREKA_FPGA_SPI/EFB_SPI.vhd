...
-- Module  Version: 1.2
--C:\lscc\diamond\3.8_x64\ispfpga\bin\nt64\scuba.exe -w -n EFB_SPI -lang vhdl -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq .5 -spi -spi_mode Slave -spi_rxr -spi_txr -ufm -ufm_ebr 2045 -mem_size 1 -ufm_0 -wb -dev 7000 
...
begin
    ...
    EFBInst_0: EFB
        ...
        port map (WBCLKI=>wb_clk_i, WBRSTI=>wb_rst_i, WBCYCI=>wb_cyc_i, 
            ...
            TCIC=>scuba_vlo, UFMSN=>ufm_sn, WBDATO7=>wb_dat_o(7), 
            ...
            WBCUFMIRQ=>wbc_ufm_irq, CFGWAKE=>open, CFGSTDBY=>open);
