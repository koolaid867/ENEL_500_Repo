...
-- Module  Version: 5.7
--C:\Program Files\diamond\3.8_x64\ispfpga\bin\nt64\scuba.exe -w -n WISHBONE_ENABLE -lang vhdl -synth lse -arch xo2c00 -type pll -fin 100 -fclkop 100 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -wb 

-- Fri Feb 24 15:49:18 2017
...
architecture Structure of WISHBONE_ENABLE is
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of WISHBONE_ENABLE is
    for Structure
