...
-- Module  Version: 1.2
--C:\Program Files\diamond\3.8_x64\ispfpga\bin\nt64\scuba.exe -w -n SPI_SLAVE -lang vhdl -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq .5 -spi -spi_mode Slave -spi_lsb -pll1 -wb -dev 7000 

-- Fri Feb 24 15:02:01 2017
...
begin
    ...
    EFBInst_0: EFB
        ...
        SPI_LSB_FIRST=> "ENABLED", SPI_CLK_DIVIDER=>  1, SPI_MODE=> "SLAVE", 
        ...
        EFB_I2C1=> "DISABLED", EFB_WB_CLK_FREQ=> "0.5")
        port map (WBCLKI=>wb_clk_i, WBRSTI=>wb_rst_i, WBCYCI=>wb_cyc_i, 
            ...
            WBDATO0=>wb_dat_o(0), WBACKO=>wb_ack_o, 
